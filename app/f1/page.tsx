      ...
      <Header 
        ...
        extra={
          <div className="flex items-center gap-3">
            {/* F1 Logo */}
            <a href="https://www.formula1.com" target="_blank" rel="noopener noreferrer" className="flex h-12 w-12 items-center justify-center overflow-hidden shrink-0 hover:opacity-80 transition-opacity">
              <img src="/f1-logos/formula1.svg" alt="Formula 1 Official Website" className="w-full h-full object-contain" />
            </a>
            {/* TV360 Logo */}
            <a href="https://tv360.vn/tv/tv360-12?ch=10001&col=7808461&sect=LIVE&page=home_live&c=0" target="_blank" rel="noopener noreferrer" className="flex h-10 w-10 items-center justify-center overflow-hidden shrink-0 hover:opacity-80 transition-opacity">
